        ...
        let process = Arc::new(Self {
            ...
            inner: unsafe {
                UPSafeCell::new(ProcessControlBlockInner {
                    ...
                    mutex_alloc: vec![core::prelude::v1::Some(0);100],
                    mutex_request: vec![core::prelude::v1::Some(0);100],
                    sem_avail: vec![0;100],
                    sem_alloc: vec![vec![0,100];100],
                    sem_request: vec![core::prelude::v1::Some(0);100],
                })
            },
        });
